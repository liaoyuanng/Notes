...
1. Accept
    ...
    `Accept`首部字段可通知服务器，*用户代理* 能够处理的媒体类型及媒体类型的相对优先级。
...
4. Accept-Language
    ...
    通知服务器用户代理能够处理的自然语言集(zh、en、jp等)及优先级。
...
5. Host
    ...
    通知服务器，请求的资源所处的互联网主机名和端口号。**这个字段是唯一一个必须被包含在请求内的首部字段**
